...
<form action=""  method="POST" >
      ...
      <div class="form-group row  ">
      <label class="col-sm-4 col-form-label">sell Date</label>
      <div class="col-sm-8">
      ...
      <div class="modal-footer">
        ...
        <button type="submit"   name="sell_request_btn" class="btn btn-primary">Send Request</button>
      </div>
...
if(isset($_POST['sell_request_btn']) ){ 
