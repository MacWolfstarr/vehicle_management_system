...
<?php
      ...
      if (!isset($_SESSION['user_email'] )) {
        header('Location:sell_edit_admin.php');
        ...
        if(isset($_POST['rent_edit'])){
          ...
          $sql = "UPDATE rent
              ...
              if (mysqli_query($conn, $sql)) { 
                $msg ="Rent Add Edited Successfully!";
              } else {
...
<div class="form-group row  ">
      ...
      <div class="col-sm-4">
          <input type="text" name ="rent_id"  value="<?php echo $row['rent_id']?>" class="form-control" disabled>
      </div>
    </div>
...
<div class="form-group row  ">
    ...
    <div class="form-group row">
      <div class="col-sm-10">
        <input type="submit" name="rent_edit" value="Edit Add" class="btn btn-primary">
      </div>
    </div>
